            ...
            <div class="p-5">
              ...
              <form class="user" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group row">
                  ...
                  <input hidden type="text" name="rider">
              ...
              <div class="text-center">
                <a class="small" href="{{ route('vendor.register') }}">Create an Vendor Account!</a>
              </div> 

              <div class="text-center">
                <a class="small" href="{{ route('rider.register') }}">Create an Rider Account!</a>
              </div> 
