...
<div class="row justify-content-center">
        ...
        <h6 class="text-center" style="font-weight: bold;">Update Shop!</h6>

          <form class="text-left border border-dark p-2" method="POST" action="{{ route('vendor.shopPost') }}" enctype="multipart/form-data">         
               @csrf
               ...
               <input type="text" name="s_id" class="form-control mb-4" value="{{$shops->id}}" hidden >
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                          <input  type="text"  name="s_status" value="{{$shops->s_status}}" hidden/>
                          <label for="gender">Shop Status : </label>
                          <span> {{$shops->s_status}} </span><br>                         
                    </div> 
      ...
      <div class="modal-content">
            ...
            <form class="border border-light p-5" method="POST" action="{{ route('vendor.addProducts') }}" enctype="multipart/form-data">
            @csrf
                                    ...
                                    @foreach($shop->reverse() as $s_value)
                                          ...
                                          @if ($value->category == $p_value->id && $value->shop == $s_value->id)
                                                <tr>
                                                      ...
                                                      <td><a href="{{ route('vendor.updateProductsGet',$value->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                
                                                      <a href="{{ route('vendor.delateProducts',$value->id) }}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>                                                                       
                                                </tr>
                                          @endif
